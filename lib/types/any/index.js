...
module.exports = internals.Any = class {
    ...
    options(options) {
        ...
        Utils.assert(!options.context, 'Cannot override context');
    ...
    when(condition, options) {
        ...
        Utils.assert(options && typeof options === 'object', 'Invalid options');
    ...
    meta(meta) {
        ...
        Utils.assert(meta !== undefined, 'Meta cannot be undefined');
    ...
    example(...args) {
        ...
        Utils.assert(args.length === 1, 'Missing example');
        const value = args[0];
    ...
    _validate(value, state, options, reference) {
        ...
        const finish = () => {
            ...
            if (value !== undefined) {
                ...
                finalValue = Utils.clone(this._flags.default);
            }
