...
internals.String = class extends Any {
    ...
    email(isEmailOptions) {
        ...
        if (isEmailOptions) {
            Utils.assert(typeof isEmailOptions === 'object', 'email options must be an object');
            Utils.assert(typeof isEmailOptions.checkDNS === 'undefined', 'checkDNS option is not supported');
            Utils.assert(typeof isEmailOptions.tldWhitelist === 'undefined' ||
    ...
    ip(ipOptions = {}) {
        ...
        Utils.assert(typeof ipOptions === 'object', 'options must be an object');
    ...
    uri(uriOptions) {
        ...
        if (uriOptions) {
            Utils.assert(typeof uriOptions === 'object', 'options must be an object');
    ...
    base64(base64Options = {}) {
        ...
        // Validation.
        Utils.assert(typeof base64Options === 'object', 'base64 options must be an object');
        Utils.assert(typeof base64Options.paddingRequired === 'undefined' || typeof base64Options.paddingRequired === 'boolean',
...
internals.compare = function (type, compare) {
    ...
    return function (limit, encoding) {
        ...
        Utils.assert(!encoding || Buffer.isEncoding(encoding), 'Invalid encoding:', encoding);
