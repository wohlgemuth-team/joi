...
internals.Object = class extends Any {
    ...
    _base(value, state, options) {
        ...
        const unprocessed = Utils.mapToObject(Object.keys(target));
    ...
    keys(schema) {
        ...
        Utils.assert(schema === null || schema === undefined || typeof schema === 'object', 'Object schema must be a valid object');
    ...
    pattern(pattern, schema) {
        ...
        Utils.assert(pattern instanceof RegExp, 'Invalid regular expression');
    ...
    assert(ref, schema, message) {
        ...
        return this._test('assert', { schema, ref }, function (value, state, options) {
            ...
            const localState = Utils.merge({}, state);
            localState.key = key;
...
internals.nand = function (value, peers, parent, state, options) {
    ...
    const values = Utils.clone(peers);
