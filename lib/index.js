...
const Utils = require('project-utils/dist');
...
internals.root = function () {
    ...
    root.any = function (...args) {
        ...
        Utils.assert(args.length === 0, 'Joi.any() does not allow arguments.');
    ...
    root.array = function (...args) {
        ...
        Utils.assert(args.length === 0, 'Joi.array() does not allow arguments.');
    ...
    root.boolean = root.bool = function (...args) {
        ...
        Utils.assert(args.length === 0, 'Joi.boolean() does not allow arguments.');
    ...
    root.date = function (...args) {
        ...
        Utils.assert(args.length === 0, 'Joi.date() does not allow arguments.');
    ...
    root.func = function (...args) {
        ...
        Utils.assert(args.length === 0, 'Joi.func() does not allow arguments.');
    ...
    root.number = function (...args) {
        ...
        Utils.assert(args.length === 0, 'Joi.number() does not allow arguments.');
    ...
    root.string = function (...args) {
        ...
        Utils.assert(args.length === 0, 'Joi.string() does not allow arguments.');
    ...
    root.defaults = function (fn) {
        ...
        joi._defaults = (schema) => {
            ...
            if (this._defaults) {
                schema = this._defaults(schema);
                Utils.assert(schema instanceof this.constructor, 'defaults() must return a schema');
            }
    ...
    root.extend = function (...args) {
        ...
        const extensions = Utils.flatten(args);
